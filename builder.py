...
# ТУТ ВИПРАВЛЕНО: додані точні назви операцій, які генерує новий parser.py
_OP_TO_COL = {
    'ПрВ (Прихід)':                'ПрВ',
    'Кнк (Продажі)':               'Кнк',  # Нова назва
    'Кнк (Продаж)':                'Кнк',  # Стара назва (на всяк випадок)
    'ПрИ (Переміщення)':           'ПрИ',
    'Ппт (Переміщення Прихід)':    'ПрВ',
    'Ппт (Переміщення Розхід)':    'ПрИ',
    'СпП (Списання)':              'СпП',
    'Апс (Акт пересорту)':         'Апс',  # Нова назва
    'Апк (Корегування)':           'Апс',  # Стара назва
}
